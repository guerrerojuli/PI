...
int main(void) {
  setADT set1 = newSet((int (*)(elemType, elemType))strcmp);
  setADT set2 = newSet((int (*)(elemType, elemType))strcmp);
  setADT ans;
  int ok;
  ...
  set1 = newSet((int (*)(elemType, elemType))strcmp);
  set2 = newSet((int (*)(elemType, elemType))strcmp);
  ok = addElement(set1, "amelia");
