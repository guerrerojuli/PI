...
int main(void) {
  ...
  addRelated(
      soc, "juan",
      "john"); // Ahora los amigos de juan son "ana", "john", "juana" y "pedro"
  addRelated(soc, "juan", "john"); // Ahora los amigos de juan son "ana",
                                   // "john", "john", juana" y "pedro"
  ...
  // Pero si el TAD aplica programación defensiva no debería causar problemas el
  // pasarle un nombre de mayor longitud, a lo sumo podría cortarlo.
  soc = newSocial();
